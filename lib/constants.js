...
export const BOOST_OPTIONS = [
  ...
  {
    id: 'duo',
    label: 'Escolha a Lane',
    description: 'Escolha sua lane preferida para o boost',
    percentage: 50,
    icon: '👥',
  },
  {
    ...
    description: 'Assista suas partidas ao vivo (GRÁTIS)',
    percentage: 0,
    icon: '📹',
  },
  {
...
export const EXTRA_SERVICES = BOOST_OPTIONS
